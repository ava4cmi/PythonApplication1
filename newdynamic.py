...
class Component:
    ...
    def attrib(self, cId, cName, cOwner, cUser, cLang, cUIcom, cSanit, cTrans, cTransf, cTrust, cDBint, cTime, cMaxmin, cLocalf, cSpoof, cTamper, cEncryp, cAttach, cUError, cRemotef, cDataf, cCliSer, cPCWS, cAS, cIS, cNC, cPC):
        self.cId=cId 
        self.cName=cName 
        self.cOwner=cOwner 
        self.cUser=cUser 
...
if __name__ == '__main__':
    ...
    cweAtts = ["Owner","User","Programming_Language","User_Interface","Sanitize","Transform_Data","Transfering_Data","Trust", \
        "Database_Interaction","Timeout_Operations","Max_Min_Operations","Local_Thirdparty","Spoofing","Tampering","Encryption",\
        "Attachment","Data_File_Format","Unexpected_Error_handling","Remote_Thirdparty","Client_Server_Installation"]
